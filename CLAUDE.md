...
│   ├── create-debian-vm.sh      # Main VM creation with cloud-init
...
│   ├── password-generator.sh   # Password generation utilities
│   ├── phonetic-words.txt      # Word list for passwords
│   └── semaphore-api.sh        # Semaphore API functions
...
- `bootstrap/scripts/create-debian-vm.sh` - Core VM creation logic
...
- Use lib functions for password generation
...
Historical lessons and fixes have been incorporated into this document.
